<?php
	...
	class DI_Container {
		...
		private static function initControllers() {
			...
			self::setController('admin', new AdminController(self::getModel('admin'), self::getModel('user'), self::getModel('buyer'), self::getModel('seller'), self::getModel('product'), self::getModel('productImage')));
